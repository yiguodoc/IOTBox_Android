...
public class SerialPortPreferences extends PreferenceActivity implements  
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Sever IP
		final EditTextPreference serverIP = (EditTextPreference) findPreference("SERVER_IP");
		serverIP.setSummary(serverIP.getText());
		serverIP.setOnPreferenceChangeListener(this);
		
		// Sever Port
		final EditTextPreference serverPort = (EditTextPreference) findPreference("SERVER_PORT");
